...
<html>
    <head>
        ...
        <title>Manage Products |  Manoj Motors</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <a href="create-product.php"><h2> Create Product</h2></a>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr id="item-<?php echo $product['id'];?>">
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" data-status="<?php echo $product['status'];?>" data-id="<?php echo $product['id'];?>" class="inactive-item">
                                            <?php 
                                                if($product['status'] == 1) 
                                                { 
                                                    echo "Inactive"; 
                                        ...
                                        <a href="javascript:void(0);" data-id="<?php echo $product['id'];?>" class="delete-item">
                                            Delete
                                        </a>
                                    </td>
                                </tr>
