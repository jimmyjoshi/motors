...
<html>
    <head>
        ...
        <title>Upload Paints | theart.nyc</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label>Media Category : </label>
                                 <label><input type="radio" checked="checked" name="category" value="Paint">Paint</label>
                                    <label><input type="radio" name="category" value="graphic">Graphics</label>
                                    <label><input type="radio" name="category" value="Mixed_Media">Mixed Media</label>
                                    ...
                                    <label><input type="radio" name="category" value="Photography">Photography</label>
                                    <label><input type="radio" name="category" value="Drawing">Drawing</label>
                                    <label><input type="radio" name="category" value="Fashion">Fashion</label>
                                    <label><input type="radio" name="category" value="Dance">Dance
                                    </label>
                            </div>
                            <div class="col-md-8">
    ...
    <script>
        ...
        var galleryDropZone = new Dropzone("#myImageUploadZone", 
        {
            ...
            { 
                ...
                {
                    swal("Good job!", "Your Image Uploaded Succesfuly !", "success");
                    window.location.assign("media.php");
                }
            },
            ...
            complete: function()
            {
                ...
                swal("Good job!", "Your Image Uploaded Succesfuly ! You will be redirct to Listing soon.", "success");
                setTimeout(function()
                {
                    window.location.assign("media.php");
                }, 8000);
