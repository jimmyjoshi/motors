...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini manage_video">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <?php /*
                	...
                	{
                ?>
                	<div class="upload_btn" style="text-align: left;">
                    	<a class="btn btn-danger" href="upload-video.php"><i class="fa fa-upload"></i> Upload</a>
                    </div>
