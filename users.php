...
$users = $object->getAllSalesExecutives();   
...
<html>
    <head>
        ...
        <title>Manage Sales Executives |  Manoj Motors</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div>
                    <a href="create-sales-executive.php">
                        <h3> Create New Sales Executive </h3>
                    </a>
                </div>
                            ...
                            ?>
                                <tr id="item-<?php echo $user['id'];?>">
                                    ...
                                    <td>
                                        ...
                                        |
                                         <a href="edit-sales-executive.php?id=<?php echo $user['id'];?>">
                                            Edit
                                        </a>
                                        |
