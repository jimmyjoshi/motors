...
if(isset($_GET['type']) && $_GET['type'] == 'graphic')
{
	$keyword = 'graphic';
}
...
if(isset($_GET['type']) && $_GET['type'] == 'dance')
{
	$keyword = 'dance';
}
               ...
               <section class="content-header">
                ...
                ?>
                	<div class="upload_btn">
                    	<a class="btn btn-danger" href="upload-image.php"><i class="fa fa-upload"></i> Upload</a>
                    </div>
                <?php
                	}*/
                ?>
                   <table id="mediaTable" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
					   <thead>
						<tr>
							<td>Sr</td>
							<td>Name</td>
